const Header = () => {
	return (
		<header className="[grid-area:header] bg-gradient-to-r from-indigo-600/90 via-indigo-500/90 to-violet-600/90 backdrop-blur-sm border-b border-white/10">
			<div className="flex items-center justify-center gap-2 px-4 py-3 sm:gap-3 sm:px-6 sm:py-5">
				...
				<div>
					<h1 className="text-lg font-black tracking-tight sm:text-2xl">When and Where</h1>
